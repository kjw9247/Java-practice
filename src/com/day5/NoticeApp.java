...
// 공지사항 입력 화면/처리
// 자바는 단일 상속만 지원을 한다
// 단일 상속의 단점을 보완하기 위해서 인터페이스를 지원함
public class NoticeApp extends JFrame implements ActionListener {// JFrame을 상속 받았다
    // 선언부
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(obj == jmi_all || obj == btnAll){
            noticeList();
        } else if (obj == jmi_del || obj == btnAll) {
