...
public class MapApi2 {
    public static void main(String[] args) {
        ...
        System.out.println(map.get(100)); // 노링, 초록, 파랑
        System.out.println(map2.get(100)); // 노링, 초록, 파랑
    }
}
/*
정리
- clone 은 맵 자체만 새로 만들고 내부 객체는 동일한 주소 참조한다
- 값이 String이나 원시형 타입은 문제 없지만
만일 값이 List, VO, 배열등의 참조형이면 반드시 깊은 복사를 직접 구현해야 한다
 */