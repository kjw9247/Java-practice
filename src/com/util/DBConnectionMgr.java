...
// 인스턴스화
// 파라미터가 없는 생성체를 디폴트 생성자 라고 하고 생략하면 JVM제공해줌
// 자바가 제공하는 클래스는 생성자의 숫자도 정해져 있다
// 인스턴스화를 한줄 보다는 두 줄 컷으로 연습하기
// 게으른 생성(주입)과 이른 생성(주입) 시점의 차이
// 게으른 생성 - 당장 필요할 때 생성
// 이른 생성 - 미리 말해주면 미리 메모리에 띄워놓을게
// A a = new A();
...
public class DBConnectionMgr {
    ...
    // 객체마다 lock flag
    // 어떤 객체가 아래 메서드 진입을 하면 잠긴다 - 스레드 안전- 속도는 느리다
