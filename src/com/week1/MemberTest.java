...
class Member1{
    ...
    // 공동사항은 setter/getter 모두 public 선언한다
    // getter - lombok 사용하면 필요없다
    // getter는 파라미터는 필요가 없지만 리턴타입은 필요하다
    // setter는 save/write이니까 파라미터가 필요하다
    // 리턴타입은 필요없다
    // setter 호출하면 전변에 저장된다
    // getter 호출하면 전변에 저장된 값을 읽어온다
...
public class MemberTest {
    ...
    MemberTest mt1 = new MemberTest();
        ...
        System.out.println(mt1.mems[1]);
        System.out.println(mt1.mems[2]);
    }
}
